        ...
        stage('Run SonarQube Analysis') {
            steps {
                ...
                script {
                    ...
                    sh ''' $SCANNER_HOME/bin/sonar-scanner -Dsonner.host.url=http://http://192.168.33.10:9000/ -Dsonner.login=squ_50037a514a69bbf4c886e8b755e1c367dfe6ed48 -Dsonner.projectName=eventsProject \
